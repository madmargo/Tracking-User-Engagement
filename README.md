...
* Database for this project is from 365 Data Science. It can be found at: https://learn.365datascience.com/projects/tracking-user-engagement-with-sql-excel-and-python/data-preparation-with-sql-creating-a-view-task/
